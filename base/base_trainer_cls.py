...
class BaseTrainer:
    ...
    """
    def __init__(self, model, criterion, data_set, metric_ftns = None, optimizer =None, config = None):
        self.config = config
    ...
    def train(self):
        ...
        mskf = KFold(n_splits=self.config["fold_split"], shuffle=True, random_state=None)

        for kfold, (train_index, validate_index) in enumerate(mskf.split(self.data_set)):
